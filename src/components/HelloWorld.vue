<template>
  ...
  <div class="wrapper">
    <section class="section-profile-cover section-shaped my-0">
      <!-- Circles background -->
      <img class="bg-image" src="../assets/img/header.jpg" style="width: 100%;">
      <!-- SVG separator -->
        ...
        <div class="card card-profile shadow mt--300">
          <div class="px-4">
            ...
            <div class="text-center mt-5">
              <h3>Tom Grootjans<span class="font-weight-light">, 26</span></h3>
              <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i>Zoetermeer, The Netherlands</div>
              <div class="h6 mt-4"><i class="ni business_briefcase-24 mr-2"></i>(Backend) Web developer @ EST Digital BV</div>
